...
2. You should go join Slack as directed near the bottom of the [Program Introduction page](https://github.com/byuccl/f4pga-classroom/blob/dev/Instructions/F4PGAClassroomIntroduction.md).
