...
There may be times when you are instructed to update your copy of `symbiflow-examples`.  If you recall, you installed that into your home directory back in [Step2_Installing_Testing](Step2_Installing_Testing.md).  To update that you would do `cd ~/symbiflow-examples` and then `git pull`.  Your `symbiflow-examples` code will be updated.
